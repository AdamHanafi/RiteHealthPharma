    ...
    <div class="container-fluid bg-primary py-5 hero-header mb-5">
        <div class="row py-3">
            <div class="col-12 text-center">
                <h1 class="display-3 text-white animated zoomIn">Multi-Dose Packaging</h1>
                <a href="" class="h4 text-white">Home</a>
                <i class="far fa-circle text-white px-2"></i>
                <a href="" class="h4 text-white">Multi-Dose Packaging</a>
            </div>
        </div>
    </div>
    <!-- Hero End -->
            ...
            <div class="row g-5">
                <div class="col-lg-5">
                    <div class="section-title mb-4">
                        ...
                        <h1 class="display-5 mb-0">Multi-Dose Packaging</h1>
                        <h4></h4>
                    </div>
                    <p class="mb-4">You may find that you have been prescribed a number of medications, and that you need to take them at different times of the day. It can be difficult to keep track of what medication you need to take and when.</p>
                    <p class="mb-4">Good news! We can offer you an easier and safer way to take your medications. You will wonder why you never tried it before.</p>
                    <p class="mb-4">We offer a multi-dose packaging that bundles your medications together by date and time. For example, all your medications that are to be taken in the morning will be packaged together in one pack. Say Goodbye to pill boxes and all of your pill bottles, and say hello to multi-dose packaging.</p>
                ...
                <div class="col-lg-5" style="min-height: 500px;">
                    <div class="position-relative h-100">
                        <img class="position-absolute w-60 h-60 rounded wow zoomIn" data-wow-delay="0.9s" src="img/Multi-Dose.jpg" style="object-fit: cover;visibility: visible;animation-delay: 0.9s;animation-name: zoomIn;left: 0.5px; width: 350px;height: 350px;"">
                    </div>
                </div>
            </div>
        </div>
