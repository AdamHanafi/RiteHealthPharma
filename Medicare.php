    ...
    <div class="container-fluid bg-primary py-5 hero-header mb-5">
        <div class="row py-3">
            <div class="col-12 text-center">
                <h1 class="display-3 text-white animated zoomIn">Medicare</h1>
                <a href="" class="h4 text-white">Home</a>
                <i class="far fa-circle text-white px-2"></i>
                <a href="" class="h4 text-white">Medicare</a>
            </div>
        </div>
    </div>
    <!-- Hero End -->
            ...
            <div class="row g-5">
                <div class="col-lg-5">
                    <div class="section-title mb-4">
                        ...
                        <h1 class="display-5 mb-0">Medicare Enrollment</h1>
                        <h4>Medicare Part D Open Enrollment is Oct. 15 - Dec. 7</h4>
                    </div>
                    <p class="mb-4">Your Medicare Part D plan changes every year. Make sure it is still the right one for you. Did you pay too much for your Medicare Part D deductible last year? Open Enrollment is an opportunity for you to switch insurance coverage to a plan that best suits your needs.

Understanding Medicare prescription plans can seem daunting, but it doesn’t have to be. Our staff can review your coverage and find the plan that's best for your needs!</p>
                    <p class="mb-4">Talk to a staff member to learn more.</p>
                    <p class="mb-4"></p>
                ...
                <div class="col-lg-5" style="min-height: 500px;">
                    <div class="position-relative h-100">
                        <img class="position-absolute w-60 h-60 rounded wow zoomIn" data-wow-delay="0.9s" src="img/medcare.jpg" style="object-fit: cover;visibility: visible;animation-delay: 0.9s;animation-name: zoomIn;left: 0.5px; width: 350px;height: 350px;"">
                    </div>
                </div>
            </div>
        </div>
