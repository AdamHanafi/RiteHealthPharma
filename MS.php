    ...
    <div class="container-fluid bg-primary py-5 hero-header mb-5">
        <div class="row py-3">
            <div class="col-12 text-center">
                <h1 class="display-3 text-white animated zoomIn">Medication Synchronization</h1>
                <a href="" class="h4 text-white">Home</a>
                <i class="far fa-circle text-white px-2"></i>
                <a href="" class="h4 text-white">Medication Synchronization</a>
            </div>
        </div>
    </div>
    <!-- Hero End -->
            ...
            <div class="row g-5">
                <div class="col-lg-5">
                    <div class="section-title mb-4">
                        ...
                        <h1 class="display-5 mb-0">Meds Synchronization</h1>
                        <h4></h4>
                    </div>
                    <p class="mb-4">Do you ever find it difficult to keep up with your medication refills and picking up your medications? If you answered yes, you may benefit from medication synchronization.</p>
                    <p class="mb-4">Med Synchronization, also called med sync, is a program we offer here at the pharmacy to help synchronize your medication refills so that you will be able to pick up ALL of your medications on a single day each month.</p>
                    <p class="mb-4">Speak to a staff member today about how we can get you set up on med sync.</p>
                    <p class="mb-4"></p>
                ...
                <div class="col-lg-5" style="min-height: 500px;">
                    <div class="position-relative h-100">
                        <img class="position-absolute w-60 h-60 rounded wow zoomIn" data-wow-delay="0.9s" src="img/Med Sync 29.jpg" style="object-fit: cover;visibility: visible;animation-delay: 0.9s;animation-name: zoomIn;left: 0.5px; width: 350px;height: 350px;"">
                    </div>
                </div>
            </div>
        </div>
