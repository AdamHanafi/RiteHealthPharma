    ...
    <div class="container-fluid bg-primary py-5 hero-header mb-5">
        <div class="row py-3">
            <div class="col-12 text-center">
                <h1 class="display-3 text-white animated zoomIn">Medication</h1>
                <a href="" class="h4 text-white">Home</a>
                <i class="far fa-circle text-white px-2"></i>
                <a href="" class="h4 text-white">Medication</a>
            </div>
        </div>
    </div>
    <!-- Hero End -->
            ...
            <div class="row g-5">
                <div class="col-lg-5">
                    <div class="section-title mb-4">
                        ...
                        <h1 class="display-5 mb-0">Medication Adherence</h1>
                    </div>
                ...
                <div class="col-lg-5" style="min-height: 500px;">
                    <div class="position-relative h-100">
                        <img class="position-absolute w-60 h-60 rounded wow zoomIn" data-wow-delay="0.9s" src="img/Medication Adherence.jpeg" style="object-fit: cover;visibility: visible;animation-delay: 0.9s;animation-name: zoomIn;left: 0.5px; width: 350px;height: 350px;"">
                    </div>
                </div>
            </div>
        </div>
